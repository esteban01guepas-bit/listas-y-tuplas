...
print("Nombre completo: ", nombre, nombre2, apellido, apellido2)
print("Edad:", edad, "años")
print("Peso:", peso, "kg")
print("Altura:", altura, "m")
print("Teléfono:", telefono)
print("Número de hijos:", hijos)
print(f"Fecha de nacimiento: {dia_nacimiento}/{mes_nacimiento}/{año_nacimiento}")
print("Cédula:", cedula)
print("Correo:", correo)
...
#=======================================
#EsTEBAN Formulario completado exitosamente!
